...
const Map: React.FC = () => {
  // Coordinates for Kuishi Dina 36a, Astana
  const address = "Куйши Дина 36а, Астана, Казахстан";
