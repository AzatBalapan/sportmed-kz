...
const News: React.FC = () => {
 ...
 id: 'new-article-10',
        ...
        alt: language === 'ru' ? 'Айдос Султангали - чемпион мира!' : language === 'kz' ? 'Айдос Сұлтанғали - әлем чемпионы!' : 'Aidos Sultangali is the champion of the world!',
        ...
        textPath: `/news/${language === 'ru' ? '10/10_rus.txt' : '10/10_kaz.txt'}`,
