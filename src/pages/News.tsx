    ...
    const newsConfig = [
       {
        ...
        alt: language === 'ru' ? 'Конкурс на должность руководителя ГККП «Спортивный медицинский центр города Астаны».' : language === 'kz' ? 'Астана қаласы әкімдігінің «Спорттық медициналық орталығы» МКҚК басшысы бос лауазымына конкурс.' : 'Астана қаласы әкімдігінің «Спорттық медициналық орталығы» МКҚК басшысы бос лауазымына конкурс.',
        title: language === 'ru' ? 'Конкурс на должность руководителя ГККП «Спортивный медицинский центр города Астаны».' : language === 'kz' ? 'Астана қаласы әкімдігінің «Спорттық медициналық орталығы» МКҚК басшысы бос лауазымына конкурс.' : 'Астана қаласы әкімдігінің «Спорттық медициналық орталығы» МКҚК басшысы бос лауазымына конкурс.',
      ...
      },
      {
        ...
        alt: language === 'ru' ? 'Врачи Центра спортивной медицины обеспечили полное медицинское сопровождение международного турнира Open President Cup по настольному теннису в Астане.' : language === 'kz' ? 'Спорттық медицина орталығының дәрігерлері Астанадағы үстел теннисінен Open President Cup халықаралық турнирінің толық медициналық сүйемелдеуін қамтамасыз етті.' : 'Doctors from the Center for Sports Medicine provided full medical support for the Open President Cup International Table Tennis Tournament in Astana.',
