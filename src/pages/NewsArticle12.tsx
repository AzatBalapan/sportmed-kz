...
const NewsArticle12: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fileName = language === 'ru' ? '12/12_rus.txt' : '12/12_kaz.txt';
    fetch(`/news/${fileName}`)
  ...
  const photoList = [1, 2, 3, 4].map(num => `/news/12/photos/${num}.png`);
          ...
          <Card className="shadow-lg">
            <CardContent className="p-4 md:p-8">
              ...
              <h1 className="text-xl md:text-3xl font-serif font-bold text-gov-blue mb-4 md:mb-6">
                {language === 'ru' ? 'В Астане завершился Кубок Казахстана по волейболу сезона 2025 года' :
                 language === 'kz' ? 'Астанада 2025 маусымындағы волейболдан Қазақстан Кубогы аяқталды' :
              ...
              <div className="mt-6 md:mt-8">
                <h2 className="text-lg md:text-xl font-serif font-bold text-gray-800 mb-4 md:mb-6">
                  {language === 'ru' ? 'Фотографии с турнира' :
                   language === 'kz' ? 'Сайыстан фотосуреттер' :
                   'Training Photos'}
                </h2>
