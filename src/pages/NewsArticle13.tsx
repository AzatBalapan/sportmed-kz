...
Әңгімелесу 2026 жылғы 10 наурызда сағат 10:00-де онлайн форматта (Zoom платформасы) өтеді.`;
  ...
  const pdfFiles = language === 'ru'
    ? [
        { label: 'Протокол №1 (русский)', path: '/news/13/Протокол.pdf' },
        { label: 'График собеседования (русский)', path: '/news/13/Сұхбат_русс.pdf' },
        { label: 'Хаттама №1 (казахский)', path: '/news/13/Хаттама.pdf' },
        { label: 'Әңгімелесу кестесі (казахский)', path: '/news/13/Сұхбат_каз.pdf' },
      ]
    : [
        { label: 'Хаттама №1 (қазақша)', path: '/news/13/Хаттама.pdf' },
        { label: 'Әңгімелесу кестесі (қазақша)', path: '/news/13/Сұхбат_каз.pdf' },
        { label: 'Протокол №1 (орысша)', path: '/news/13/Протокол.pdf' },
        { label: 'Сұхбат кестесі (орысша)', path: '/news/13/Сұхбат_русс.pdf' },
      ];
